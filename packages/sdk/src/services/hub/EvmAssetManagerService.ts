...
import type { AssetInfo, ChainId, EvmContractCall } from '../../types.js';
import { assets } from '../../constants.js';
import { Erc20Service } from '../shared/Erc20Service.js';
import { EvmVaultTokenService } from './EvmVaultTokenService.js';
import type { EvmHubProvider, EvmSpokeProvider } from '../../entities/Providers.js';
...
export class EvmAssetManagerService {
   ...
   */
  public static depositToData(params: EvmDepositToDataParams, spokeChainId: ChainId): Hex {
    const calls: EvmContractCall[] = [];
    const assetConfig = assets[spokeChainId][params.token];
